...
class HydrologicalModel(pl.LightningModule):
    def __init__(self, s1):
        ...
        self.gru1 = nn.GRU(s1[0][0], s1[0][1], batch_first=True)
    ...
    def forward(self, x, initial_values):
        ...
        out1 = self.fc2(torch.relu(self.gru1(x)[0])).squeeze(-1)
...
model = HydrologicalModel(
    s1=[[1,2,1],[1,3,1],[1,3,1],[2,3,2],[2,3,2]]
)
